...
class Dataset_Custom(Dataset):
    def __init__(self, root_path, num_people=830, flag='train', size=None, 
                 features='S', data_path='ETTh1.csv',
                 target='OT', scale=True, timeenc=0, freq='h',percent=100, # percent 여기 다름
                 seasonal_patterns=None): # num_people=1이었음 scale=True  였음
        ...
        self.timeenc = timeenc
        self.freq = freq
        self.percent = percent   # percent 여기 다름
    ...
    def __read_data__(self):
        ...
        for person_id in range(1, self.num_people + 1):
            ...
            if self.set_type == 0: # percent 이 if문 추가됨
                border2 = (border2 - self.seq_len) * self.percent // 100 + self.seq_len
